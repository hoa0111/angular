...
public class SecurityPath {
    public static final List<String> PUBLIC_PATHS = new ArrayList<>();
	public List<SecurityDataSource> getPathSecurity() {
		...
		try (BufferedReader reader = new BufferedReader(new InputStreamReader(resource.getInputStream()))) {
			...
			while ((line = reader.readLine()) != null) {
				...
				if (line.startsWith("permitAll()") || line.startsWith("denyAll()") || line.startsWith("role") || line.startsWith("authenticated()") || line.startsWith("anonymous()")) {
